...
(0, globals_1.describe)("round-trip parsing and building", () => {
    ...
    (0, globals_1.it)("preserves SSH mode with Coder placeholder", () => {
        ...
        const built = (0, runtime_1.buildRuntimeString)({ mode: "ssh", host: runtime_1.CODER_RUNTIME_PLACEHOLDER });
        const parsed = (0, runtime_1.parseRuntimeModeAndHost)(built);
        (0, globals_1.expect)(parsed).toEqual({ mode: "ssh", host: runtime_1.CODER_RUNTIME_PLACEHOLDER });
    });
});
